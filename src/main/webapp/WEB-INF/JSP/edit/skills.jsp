...
<div class="panel panel-default">
	<div class="panel-body">
		<h4 class="data-header">Technicall skills in frameworks and technogies</h4>
		<hr />
		<div class="row" style="margin-bottom: 20px;">
			<div class="col-xs-5 col-sm-4 col-md-2 text-center"><strong>Categories</strong></div>
			<div class="col-xs-7 col-sm-8 col-md-10 text-center"><strong>Framework and Technologies</strong></div>
		</div>
		<%--@elvariable id="skillForm" type="net.devstudy.resume.form.SkillForm"--%>
		<form:form action="/edit/skills" method="post" commandName="skillForm">
			<div id="ui-block-container">
				<c:forEach var="skill" items="${skillForm.items}" varStatus="status">
					...
					<%--<resume:edit-skill-block index="1" skill="${skill}"/>--%>
				</c:forEach>
			</div>
			<div class="row">
				<div class="col-xs-12">
